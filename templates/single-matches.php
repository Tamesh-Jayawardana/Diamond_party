...
if ( !function_exists( 'yacht_rental_template_single_matches_theme_setup' ) ) {
	add_action( 'yacht_rental_action_before_init_theme', 'yacht_rental_template_single_matches_theme_setup', 1 );
	function yacht_rental_template_single_matches_theme_setup() {
		yacht_rental_add_template(array(
			'layout' => 'single-matches',
			'mode'   => 'single_matches',
			'need_content' => true,
			'need_terms' => true,
			'title'  => esc_html__('Single matches', 'yacht-rental'),
...
// Template output
if ( !function_exists( 'yacht_rental_template_single_matches_output' ) ) {
	function yacht_rental_template_single_matches_output($post_options, $post_data) {
		...
		if (!$post_data['post_protected']) {
			...
			get_template_part(yacht_rental_get_file_slug('templates/trx_matches/_parts/match-info.php'));
		}
		...
		?>
			<div class="match_preview"><a href="<?php echo esc_url($match_preview); ?>"><?php echo esc_html__("Go to the announcement &#8594;", 'yacht-rental'); ?></a></div>
		<?php
		} 
