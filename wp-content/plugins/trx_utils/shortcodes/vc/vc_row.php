...
if (function_exists('vc_map_get_attributes')) {						// New VC
	 ...
	 * @var $scheme		- added by Yacht rental
	 * @var $inverse	- added by Yacht rental
	 * @var $atts
	 * @var $el_class
	 * @var $full_width
	 * @var $full_height
	...
	// Added by Yacht rental:
	// Color scheme
	if ($scheme && !yacht_rental_param_is_off($scheme) && !yacht_rental_param_is_inherit($scheme)) $css_classes[] = 'scheme_'.esc_attr($scheme);
	// Inverse colors
	if ($inverse && !yacht_rental_param_is_off($inverse)) $css_classes[] = 'inverse_colors';
	...
	// Add Yacht rental color scheme in the row
	if ($scheme && !yacht_rental_param_is_off($scheme) && !yacht_rental_param_is_inherit($scheme)) $css_class .= ' scheme_'.esc_attr($scheme);
	...
	} ?> <?php yacht_rental_show_layout($style); ?>><?php
	echo wpb_js_remove_wpautop( $content );
	?></div><?php yacht_rental_show_layout($this->endBlockComment('row'));
	if ( ! empty( $full_width ) ) {
