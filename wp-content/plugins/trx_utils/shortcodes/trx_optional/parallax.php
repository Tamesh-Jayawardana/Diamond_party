...
/* Theme setup section
-------------------------------------------------------------------- */
if (!function_exists('yacht_rental_sc_parallax_theme_setup')) {
	add_action( 'yacht_rental_action_before_init_theme', 'yacht_rental_sc_parallax_theme_setup' );
	function yacht_rental_sc_parallax_theme_setup() {
		add_action('yacht_rental_action_shortcodes_list', 		'yacht_rental_sc_parallax_reg_shortcodes');
		if (function_exists('yacht_rental_exists_visual_composer') && yacht_rental_exists_visual_composer())
			add_action('yacht_rental_action_shortcodes_list_vc','yacht_rental_sc_parallax_reg_shortcodes_vc');
	}
}
...
if (!function_exists('yacht_rental_sc_parallax')) {	
	function yacht_rental_sc_parallax($atts, $content=null){	
		...
		if ($bg_video!='') {
			...
			$bg_video_width = !empty($width) && yacht_rental_substr($width, -1) >= '0' && yacht_rental_substr($width, -1) <= '9'  ? $width : 1280;
		...
		$css .= yacht_rental_get_css_dimensions_from_values($width, $height)
			...
			;
		$output = (yacht_rental_param_is_on($gap) ? yacht_rental_gap_start() : '')
			...
			. '</div>'
			. '</div>'
			. (yacht_rental_param_is_on($gap) ? yacht_rental_gap_end() : '');
		return apply_filters('yacht_rental_shortcode_output', $output, 'trx_parallax', $atts, $content);
	}
	add_shortcode('trx_parallax', 'yacht_rental_sc_parallax');
}
...
-------------------------------------------------------------------- */
if ( !function_exists( 'yacht_rental_sc_parallax_reg_shortcodes' ) ) {
	function yacht_rental_sc_parallax_reg_shortcodes() {
	
		yacht_rental_sc_map("trx_parallax", array(
...
-------------------------------------------------------------------- */
if ( !function_exists( 'yacht_rental_sc_parallax_reg_shortcodes_vc' ) ) {
	function yacht_rental_sc_parallax_reg_shortcodes_vc() {
		...
		class WPBakeryShortCode_Trx_Parallax extends Yacht_Rental_VC_ShortCodeCollection {}
	}
}
?>