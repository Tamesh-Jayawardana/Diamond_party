...
/* Theme setup section
-------------------------------------------------------------------- */
if (!function_exists('yacht_rental_sc_price_theme_setup')) {
	add_action( 'yacht_rental_action_before_init_theme', 'yacht_rental_sc_price_theme_setup' );
	function yacht_rental_sc_price_theme_setup() {
		add_action('yacht_rental_action_shortcodes_list', 		'yacht_rental_sc_price_reg_shortcodes');
		if (function_exists('yacht_rental_exists_visual_composer') && yacht_rental_exists_visual_composer())
			add_action('yacht_rental_action_shortcodes_list_vc','yacht_rental_sc_price_reg_shortcodes_vc');
	}
}
...
if (!function_exists('yacht_rental_sc_price')) {	
	function yacht_rental_sc_price($atts, $content=null){	
		...
		return apply_filters('yacht_rental_shortcode_output', $output, 'trx_price', $atts, $content);
	}
	add_shortcode('trx_price', 'yacht_rental_sc_price');
}
...
-------------------------------------------------------------------- */
if ( !function_exists( 'yacht_rental_sc_price_reg_shortcodes' ) ) {
	function yacht_rental_sc_price_reg_shortcodes() {
	
		yacht_rental_sc_map("trx_price", array(
...
-------------------------------------------------------------------- */
if ( !function_exists( 'yacht_rental_sc_price_reg_shortcodes_vc' ) ) {
	function yacht_rental_sc_price_reg_shortcodes_vc() {
		...
		class WPBakeryShortCode_Trx_Price extends Yacht_Rental_VC_ShortCodeSingle {}
	}
}
?>