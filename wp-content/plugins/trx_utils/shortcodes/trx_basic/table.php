...
/* Theme setup section
-------------------------------------------------------------------- */
if (!function_exists('yacht_rental_sc_table_theme_setup')) {
	add_action( 'yacht_rental_action_before_init_theme', 'yacht_rental_sc_table_theme_setup' );
	function yacht_rental_sc_table_theme_setup() {
		add_action('yacht_rental_action_shortcodes_list', 		'yacht_rental_sc_table_reg_shortcodes');
		if (function_exists('yacht_rental_exists_visual_composer') && yacht_rental_exists_visual_composer())
			add_action('yacht_rental_action_shortcodes_list_vc','yacht_rental_sc_table_reg_shortcodes_vc');
	}
}
...
if (!function_exists('yacht_rental_sc_table')) {	
	function yacht_rental_sc_table($atts, $content=null){	
		...
		$output = '<div' . ($id ? ' id="'.esc_attr($id).'"' : '') 
				...
				. $content
				. '</div>';
		return apply_filters('yacht_rental_shortcode_output', $output, 'trx_table', $atts, $content);
	}
	add_shortcode('trx_table', 'yacht_rental_sc_table');
}
...
-------------------------------------------------------------------- */
if ( !function_exists( 'yacht_rental_sc_table_reg_shortcodes' ) ) {
	function yacht_rental_sc_table_reg_shortcodes() {
	
		yacht_rental_sc_map("trx_table", array(
...
-------------------------------------------------------------------- */
if ( !function_exists( 'yacht_rental_sc_table_reg_shortcodes_vc' ) ) {
	function yacht_rental_sc_table_reg_shortcodes_vc() {
		...
		class WPBakeryShortCode_Trx_Table extends Yacht_Rental_VC_ShortCodeContainer {}
	}
}
?>